...
the arms here are \emph{unpaired}: thirty episodes each, healthy arm included, Fisher exact
tests.
...
\midrule
continuous adaptation & 23/30 & 1/30 & 8/30 & $0.08$ & $2.3\times10^{-4}$ \\
identify episode 0, then hold & 21/30 & 2/30 & \textbf{21/30} & $5.5\times10^{-7}$ & $1$ \\
\bottomrule
\end{tabular}
\end{center}

Held, the estimate ($83$--$118\%$ of the fault per joint) takes the humanoid from $7\%$ to
its healthy rate; updating, the same estimate reaches a third of it, not significantly
above frozen and significantly below healthy. Proposition~\ref{prop:repair} decides the
