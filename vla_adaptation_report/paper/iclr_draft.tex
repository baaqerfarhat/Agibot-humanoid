...
is paired and broad, the calibration transfers across suites and three backbones, the two
conditions that govern success are measurable in advance, and the failures are named. The
result the paper still owes is the one on a real robot.
