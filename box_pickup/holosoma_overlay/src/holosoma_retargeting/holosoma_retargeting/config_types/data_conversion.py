...
_ROBOT_JOINT_NAMES_DEFAULT = {
    ...
    # AgiBot X2 (31 DoF). Order matches the joint declaration order in
    # models/x2/x2_31dof_w_largebox.xml (legs, waist yaw/pitch/roll, arms, head),
    # which is also the retarget qpos joint-column order.
    "x2": [
        "left_hip_pitch_joint",
        "left_hip_roll_joint",
        "left_hip_yaw_joint",
