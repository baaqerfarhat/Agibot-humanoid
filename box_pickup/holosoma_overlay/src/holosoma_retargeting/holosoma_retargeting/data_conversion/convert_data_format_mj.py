...
class MotionLoader:
    ...
    def _load_motion(self):
        ...
        # Robot DoF columns sit between the 7 base coords and the trailing 7
        # object free-joint coords (when present). Compute the count dynamically
        # so this supports both 29-DoF (G1) and 31-DoF (X2) robots.
        _n_object_cols = 7 if self.has_dynamic_object else 0
        _n_dof = motion.shape[1] - 7 - _n_object_cols
        self.motion_dof_poss_input = motion[:, 7 : 7 + _n_dof]
