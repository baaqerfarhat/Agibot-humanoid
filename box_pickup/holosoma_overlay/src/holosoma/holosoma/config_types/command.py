...
class MotionConfig:
    ...
    """Uniform-mixing floor for the adaptive timesteps sampler. Higher values cap how hard the
    sampler can concentrate on the single most-failed bin, protecting the rest of the motion
    from catastrophic forgetting on short clips with one dominant failure point."""
